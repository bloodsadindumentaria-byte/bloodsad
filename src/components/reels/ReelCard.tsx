...
export function ReelCard({ reel, onOpen }: Props) {
  return (
    <div className="relative flex-none w-[180px] sm:w-[220px] aspect-[9/16] snap-start rounded-sm overflow-hidden border border-[#2a2a2a] bg-[#111111]">
      <iframe
